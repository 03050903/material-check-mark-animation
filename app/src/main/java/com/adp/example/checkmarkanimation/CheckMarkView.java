...
public class CheckMarkView extends View {
    ...
    private static final long CHECK_MARK_ANIMATION_DURATION = 5000;
    ...
    // Temp variables...
    private int[] types = {REFRESH, CHECK, EXCLAMATION, CHECK, EXCLAMATION, REFRESH, EXCLAMATION};
    private int count = 0;
